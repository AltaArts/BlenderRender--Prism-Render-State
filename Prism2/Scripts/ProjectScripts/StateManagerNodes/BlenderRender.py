...
class BlenderRenderClass(object):
...
#########################
    ...
    @err_catcher(name=__name__)                         #   ADDED               TODO
    def fmlRange(self):

        startFrame, endFrame = self.getFrameRange(rangeType="Shot")

#        middleFrame = round(int(endFrame/startFrame))

#        fmlString = f"{startFrame} -- {middleFrame} -- {endFrame}"

        fmlString = "1  --  125  --  250"                               #   TESTING
    ...
    def updateRange(self):
        ...
        self.l_fml.setVisible(isFML)
        self.e_fml.setVisible(isFML)        
