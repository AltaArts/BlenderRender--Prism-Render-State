...
################################################################################
## Form generated from reading UI file 'BlenderRenderrresUS.ui'
##
...
class Ui_wg_BlenderRender(object):
    def setupUi(self, wg_BlenderRender):
        ...
        wg_BlenderRender.resize(459, 1140)
        ...
        self.l_fml = QLabel(self.w_frameRangeValues)
        self.l_fml.setObjectName(u"l_fml")

        self.gridLayout.addWidget(self.l_fml, 0, 11, 1, 1)
        ...
        self.e_fml = QLineEdit(self.w_frameRangeValues)
        self.e_fml.setObjectName(u"e_fml")
        self.e_fml.setReadOnly(True)

        self.gridLayout.addWidget(self.e_fml, 0, 12, 1, 1)
        ...
        sizePolicy.setHeightForWidth(self.e_xRez.sizePolicy().hasHeightForWidth())
        self.e_xRez.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.e_yRez.sizePolicy().hasHeightForWidth())
        self.e_yRez.setSizePolicy(sizePolicy)
        ...
        sizePolicy.setHeightForWidth(self.e_samples.sizePolicy().hasHeightForWidth())
        self.e_samples.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.cb_renderLayer.sizePolicy().hasHeightForWidth())
        self.cb_renderLayer.setSizePolicy(sizePolicy1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 408, 69))
